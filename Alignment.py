...
class Alignment:
    ...
    def show_ptr_matrix(self,ptr, seq1, seq2) :
    ...
    def show_dp_matrix(self,s, seq1, seq2) :
    ...
    def needleman_wunsch(self,seq1, seq2) :
        ...
        if self.verbose :
            self.show_dp_matrix(s, seq1, seq2)
            self.show_ptr_matrix(ptr, seq1, seq2)
            print "\n"+"~`"*25
            print len(seq1)
    ...
    def needleman_wunsch_multiple(self,seq) :
        arrScore=[0,0,0]
        self.needleman_wunsch(seq[0],seq[1])
        arrScore[0]=self.score
        self.needleman_wunsch(seq[1],seq[2])
        arrScore[1]=self.score
        self.needleman_wunsch(seq[0],seq[2])
        arrScore[2]=self.score
        return arrScore
